...
unsigned int xIP::getIP32() const
{
    ...
    unsigned int IP32 = (convert2n[static_cast<size_t>(StrIP32[0])] << 30) + (convert2n[static_cast<size_t>(StrIP32[1])] << 24) + (convert2n[static_cast<size_t>(StrIP32[2])] << 18) + (convert2n[static_cast<size_t>(StrIP32[3])] << 12) + (convert2n[static_cast<size_t>(StrIP32[4])] << 6) + (convert2n[static_cast<size_t>(StrIP32[5])]);
